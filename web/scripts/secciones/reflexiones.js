...
function dibujarReflexiones() {
  ...
  cita.className = "reflexiones-cita";
  cita.innerHTML =
    "“Leí -o creyendo que recuerdo, invento- que existen lenguas en las cuales el mismo verbo significa ‘equivocarse’ o ‘caer en una trampa’ y al mismo tiempo ‘triunfar’ o ‘lograr su objetivo’.” <br>Roger Caillois";
...
function pintarEntrevistas(padre) {
  ...
  entrevistas.map((entrevista) => {
    ...
    const divImgs = tag("div", divG);

    const img = tag("img", divImgs);
